...
%[xData,yData,zData] = getXYZData(S1.Faces',S1.Vertices);
% if xData~=S1Obj.XData || yData~=S1Obj.YData || zData~=S1Obj.ZData
%     error('get wrong')
% end
...
%[xData,yData,zData] = getXYZData(S2.Faces',S2.Vertices);
% if xData~=S2Obj.XData || yData~=S2Obj.YData || zData~=S2Obj.ZData
%     error('get wrong')
% end
